    ...
    var tubular = function(node, options) { // should be called on the wrapper div
        ...
        var resize = function() {
            ...
            if (width / options.ratio < height) { // if new video height < window height (gap underneath)
                ...
                $tubularPlayer.width(pWidth).height("100%").css({left: 0, top: 0, right: 0, margin: "0 auto", maxWidth: "124.3vh"}); // player width is greater, offset left; reset top
            } else { // new video width < window width (gap to right)
                pHeight = Math.ceil(width / options.ratio); // get new player height
                $tubularPlayer.width("100%").height("100%").css({left: 0, top: 0, right: 0, margin: "0 auto", maxWidth: "124.5vh"}); // player height is greater, offset top; reset left
            }
